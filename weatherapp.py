...
def getWeather():
    try:
        ...
        # weather
        api = "https://api.openweathermap.org/data/2.5/weather?q=" + city + "&appid=db6f6ca8f9d4180c6a351cdad14337da"
...
w=Label(text=".....",font=("arial",20,"bold"),bg="#1ab5e6")
w.place(x=120,y=430)

h=Label(text=".....",font=("arial",20,"bold"),bg="#1ab5e6")
h.place(x=280,y=430)

d=Label(text=".....",font=("arial",20,"bold"),bg="#1ab5e6")
d.place(x=430,y=430)

p=Label(text=".....",font=("arial",20,"bold"),bg="#1ab5e6")
p.place(x=670,y=430)
